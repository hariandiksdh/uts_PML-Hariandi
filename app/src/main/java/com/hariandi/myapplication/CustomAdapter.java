...
public class CustomAdapter extends RecyclerView.Adapter<com.hariandi.myapplication.CustomAdapter.CustomViewHolder> {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        final com.hariandi.myapplication.CustomAdapter mAdapter;

        public CustomViewHolder(View itemView, com.hariandi.myapplication.CustomAdapter adapter){
            super(itemView)     ;
